            ...
            <div className = "redesign-flex-container-row">
                ...
                <div className = "redesign-flex-container-col-section">
                    <div>
                        ...
                        <p className = "redesign-section-text-font">
                    ...
                    <div>
                        <h1 id = "usability-problems" className = "redesign-section-title-font">Identify Usability Problems</h1>
                        <ul className = "redesign-section-text-font">
                    ...
                    <div>
                        <h1 id = "low-fidelity-wireframes" className = "redesign-section-title-font">Low-Fidelity Wireframes</h1>
                        <figure style = {{paddingTop: "50px"}}>
                    ...
                    <div>
                        <h1 id = "design-guide" className = "redesign-section-title-font">Visual Design Style Guide</h1>
                        <figure style = {{paddingTop: "50px"}}>
                    ...
                    <div>
                        <h1 id = "high-fidelity-prototypes" className = "redesign-section-title-font">High-Fidelity Prototypes</h1>
                        <p className = "redesign-section-text-font">
                    ...
                    <div>
                        <h1 id = "responsive-redesign" className = "redesign-section-title-font">Responsive Redesign</h1>
                        <p className = "redesign-section-text-font">
